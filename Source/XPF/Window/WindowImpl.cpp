...
// Headers
////////////////////////////////////////////////////////////
#include <XPF/Window/WindowImpl.hpp>
#include <XPF/Window/Event.hpp>
#include <XPF/Window/JoystickManager.hpp>
#include <XPF/Window/SensorManager.hpp>
#include <XPF/System/Sleep.hpp>
#include <algorithm>
#include <cmath>

#if defined(XPF_SYSTEM_WINDOWS)

    #include <XPF/Window/Win32/WindowImplWin32.hpp>
    typedef sf::priv::WindowImplWin32 WindowImplType;

#elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD)

    #include <XPF/Window/Unix/WindowImplX11.hpp>
    typedef sf::priv::WindowImplX11 WindowImplType;

#elif defined(SFML_SYSTEM_MACOS)

    #include <XPF/Window/OSX/WindowImplCocoa.hpp>
    typedef sf::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML_SYSTEM_IOS)

    #include <XPF/Window/iOS/WindowImplUIKit.hpp>
    typedef sf::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML_SYSTEM_ANDROID)

    #include <XPF/Window/Android/WindowImplAndroid.hpp>
