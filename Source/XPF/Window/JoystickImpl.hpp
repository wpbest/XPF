...
// Headers
////////////////////////////////////////////////////////////
#include <XPF/Config.hpp>
#include <XPF/Window/Joystick.hpp>
#include <XPF/System/String.hpp>
#include <algorithm>
...
struct JoystickState
{
    ...
    #include <XPF/Window/Win32/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_LINUX)

    #include <XPF/Window/Unix/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

    #include <XPF/Window/FreeBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

    #include <XPF/Window/OSX/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

    #include <XPF/Window/iOS/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

    #include <XPF/Window/Android/JoystickImpl.hpp>
