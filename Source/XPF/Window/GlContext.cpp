...
// Headers
////////////////////////////////////////////////////////////
#include <XPF/Window/GlContext.hpp>
#include <XPF/System/ThreadLocalPtr.hpp>
#include <XPF/System/Mutex.hpp>
#include <XPF/System/Lock.hpp>
#include <XPF/System/Err.hpp>
...
#include <cstring>
        ...
        #include <XPF/Window/Win32/WglContext.hpp>
        typedef sf::priv::WglContext ContextType;

    #elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD)

        #include <XPF/Window/Unix/GlxContext.hpp>
        typedef sf::priv::GlxContext ContextType;

    #elif defined(SFML_SYSTEM_MACOS)

        #include <XPF/Window/OSX/SFContext.hpp>
        ...
        #include <XPF/Window/iOS/EaglContext.hpp>
        typedef sf::priv::EaglContext ContextType;

    #else

        #include <XPF/Window/EglContext.hpp>
